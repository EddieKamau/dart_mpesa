...
const String mpesaBcUrLTest = 'https://sandbox.safaricom.co.ke/mpesa/b2c/v1/paymentrequest';

const String mpesaBbUrLTest = 'https://sandbox.safaricom.co.ke/mpesa/b2b/v1/paymentrequest';

const String mpesaReversalUrLTest = 'https://sandbox.safaricom.co.ke/mpesa/reversal/v1/request';

const String mpesaStkpushQueryUrLTest = 'https://sandbox.safaricom.co.ke/mpesa/stkpushquery/v1/query';
...
const String mpesaBbUrL = 'https://api.safaricom.co.ke/mpesa/b2b/v1/paymentrequest';

const String mpesaReversalUrL = 'https://api.safaricom.co.ke/mpesa/reversal/v1/request';

const String mpesaStkpushQueryUrL = 'https://api.safaricom.co.ke/mpesa/stkpushquery/v1/query';

const String mpesaTransactionStatusUrL = 'https://api.safaricom.co.ke/mpesa/transactionstatus/v1/query';